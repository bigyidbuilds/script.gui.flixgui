...
'''#####-----Internal Modules-----#####'''
from ._common import FromTimeStamp,Log,ToTimeStamp,DateTimeNow,DateTimeObject,DateTimeStrf
...
class DatabaseConnection(object):
	...
	def __init__(self,db):
		...
		sql = "ATTACH DATABASE '{}' AS master".format(os.path.join(xbmcvfs.translatePath('special://database'),'script.gui.flixgui.db'))
